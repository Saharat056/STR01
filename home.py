...
st.header("Saharat Wongjan")

st.balloons()
st.title('การทดสอบเขียนเว็บด้วย Python')
st.header('นาย สหรัฐ วงษ์จันทร์ ')
...
with col1:
    st.image('./pic/crepe.jpg')
with col2:
    st.image('./pic/flower.jpg')

html_1 = """
<div style="background-color:#6495ED;padding:15px;border-radius:15px 15px 15px 15px;border-style:'solid';border-color:black">
